...
class Logic {
    private com.jikexueyuan.jikecalculator.CalculatorDisplay mDisplay;
    private Symbols mSymbols = new Symbols();
    private com.jikexueyuan.jikecalculator.History mHistory;
    ...
    Logic(Context context, com.jikexueyuan.jikecalculator.History history, com.jikexueyuan.jikecalculator.CalculatorDisplay display) {
        mContext = context;
    ...
    private void clearWithHistory(boolean scroll) {
        ...
        if (MARKER_EVALUATE_ON_RESUME.equals(text)) {
            ...
            evaluateAndShowResult(text, com.jikexueyuan.jikecalculator.CalculatorDisplay.Scroll.NONE);
        } else {
            mResult = "";
            mDisplay.setText(
                    text, scroll ? com.jikexueyuan.jikecalculator.CalculatorDisplay.Scroll.UP : com.jikexueyuan.jikecalculator.CalculatorDisplay.Scroll.NONE);
            mIsError = false;
        }
    }
    ...
    private void clear(boolean scroll) {
        mHistory.enter("");
        mDisplay.setText("", scroll ? com.jikexueyuan.jikecalculator.CalculatorDisplay.Scroll.UP : com.jikexueyuan.jikecalculator.CalculatorDisplay.Scroll.NONE);
        cleared();
    }
    ...
    void onEnter() {
        if (mDeleteMode == DELETE_MODE_CLEAR) {
            ...
            evaluateAndShowResult(getText(), com.jikexueyuan.jikecalculator.CalculatorDisplay.Scroll.UP);
        }
    }
    ...
    void onUp() {
        ...
        if (mHistory.moveToPrevious()) {
            mDisplay.setText(mHistory.getText(), com.jikexueyuan.jikecalculator.CalculatorDisplay.Scroll.DOWN);
        }
    }
    ...
    void onDown() {
        ...
        if (mHistory.moveToNext()) {
            mDisplay.setText(mHistory.getText(), com.jikexueyuan.jikecalculator.CalculatorDisplay.Scroll.UP);
        }
    }
    ...
    String evaluate(String input) throws SyntaxException {
        ...
        BigDecimal value = new BigDecimal(mSymbols.eval(input));
