...
public class CalculatorEditText extends EditText {
    ...
    private synchronized void initializeReplacementTable() {
        if (sReplacementTable == null) {
            ...
            sOperators = res.getStringArray(com.jikexueyuan.jikecalculator.R.array.operators);
            String[] descs = res.getStringArray(com.jikexueyuan.jikecalculator.R.array.operatorDescs);
            int pos = 0;
    ...
    private void copyContent() {
        ...
        Toast.makeText(getContext(), com.jikexueyuan.jikecalculator.R.string.text_copied_toast, Toast.LENGTH_SHORT).show();
